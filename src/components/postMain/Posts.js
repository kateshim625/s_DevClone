...
const Posts = ({ comms, setComms}) => {
    // console.log("setComms_Post: ", setComms)
    return (
    <>
        <PostInfo>
            <div>
                ...
                <PostStyle>
                    <div>
                        <PostHone>
                        <Link to="/comms" comms={comms} setComms={setComms}>Flask Stripe Sample - Open-Source, simple eCommerce APP</Link>
                        </PostHone>
                    </div>
